...
// improvement, no backend change. Kept as inline buttons (not folded into
// the standard row-actions dropdown used elsewhere) since these are
// deliberately prominent, not buried — per the brief, credential displays
// must stay immediately actionable, not decorative.
